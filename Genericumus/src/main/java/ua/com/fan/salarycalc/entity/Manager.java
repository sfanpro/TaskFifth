...
public class Manager extends AbstractEmployeeWithLong {
	...
	public Manager(String firstName, String lastName, Double rate, Double hoursInMounth, Double workedHour,
			Role position) {
